...
<body>
    ...
    <div id="mt_wrap">
        ...
        <form action="${root}/meetingroom/add" method="POST" enctype="multipart/form-data">
            <div id="mt_main">
                <!-- 맨 윗 줄 -->
                <div class="mt_link">
                            ...
                            <tr>
                                ...
                                <td style="height: 500px;">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea" name="info" required></textarea>
                                    </div>
                                </td>
                            </tr>
                            <tr>
