        ...
        <form action="${root}/suggestion/edit" method="POST" enctype="multipart/form-data">
            ...
            <div id="fileArea">
                ...
                <div id="image_container">
                    <img src="${root}/resources/img/suggestion/${vo.changeName}" width="25px" alt="">
                </div>
            </div>
            ...
            <div id="radioArea">
                <div>
                    <a>우클릭 허용</a>
                    <input type="radio" ${vo.rightclickYn == 'Y' ? 'checked' : ''} checked name="rightclickYn" value="Y" id="radio01">
                ...
                <div>
                    <a>공개 설정</a>
                    <input type="radio" ${vo.boardLimit == '1' ? 'checked' : ''} checked name="boardLimit" value="1" id="radio03">
                    <label for="radio03">전체공개</label>
                    <input type="radio" ${vo.boardLimit == '2' ? 'checked' : ''} name="boardLimit" value="2" id="radio04">
                    <label for="radio04">관리자/운영자공개</label>
                </div>
                <div>
                    <a>댓글 작성</a>
                    <input type="radio" ${vo.commentYn == 'Y' ? 'checked' : ''} checked name="commentYn" value="Y" id="radio05">
                    <label for="radio05">허용</label>
                    <input type="radio" ${vo.commentYn == 'N' ? 'checked' : ''} name="commentYn" value="N" id="radio06">
