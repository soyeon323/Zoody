...
const pageCategoryNo = url.substring(url.lastIndexOf('/')+1);
if(pageCategoryNo == 1) {
    document.querySelector('.category-list :nth-child(1)').classList.add('selected-category');
} else if(pageCategoryNo == 2) {
    document.querySelector('.category-list :nth-child(2)').classList.add('selected-category');
} else if(pageCategoryNo == 3) {
    document.querySelector('.category-list :nth-child(3)').classList.add('selected-category');
} else if(pageCategoryNo == 4) {
    document.querySelector('.category-list :nth-child(4)').classList.add('selected-category');
}
