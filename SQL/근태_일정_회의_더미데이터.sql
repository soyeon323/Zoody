...
--);
--'0 12:15:30' DAY TO SECOND
--'2' HOUR
--INTERVAL DAY TO SECOND

INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, PLUS_WORK_TIME, OBJECTION_REASON) 
    VALUES (SEQ_ATTENDANCE_NO.NEXTVAL, 1, 1, '2023/07/10', TO_TIMESTAMP('2023-07-10 08:53:03', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-07-10 18:02:34', 'YYYY-MM-DD HH24:MI:SS'),INTERVAL '2' HOUR, null);
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, PLUS_WORK_TIME, OBJECTION_REASON) 
    VALUES (SEQ_ATTENDANCE_NO.NEXTVAL, 1, 1, '2023/07/11', TO_TIMESTAMP('2023-07-11 08:57:03', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-07-11 18:01:34', 'YYYY-MM-DD HH24:MI:SS'),INTERVAL  '0' HOUR, null);
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, PLUS_WORK_TIME, OBJECTION_REASON) 
    VALUES (SEQ_ATTENDANCE_NO.NEXTVAL, 1, 1, '2023/07/12', TO_TIMESTAMP('2023-07-12 08:55:55', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-07-12 18:00:27', 'YYYY-MM-DD HH24:MI:SS'),INTERVAL  '0 1:15:30' DAY TO SECOND, null);
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, PLUS_WORK_TIME, OBJECTION_REASON) 
    VALUES (SEQ_ATTENDANCE_NO.NEXTVAL, 1, 1, '2023/07/13', TO_TIMESTAMP('2023-07-13 08:53:03', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-07-13 18:02:34', 'YYYY-MM-DD HH24:MI:SS'),INTERVAL  '0' HOUR, null);
...
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, OBJECTION_REASON) 
    VALUES (SEQ_ATTENDANCE_NO.NEXTVAL, 1, 1, '2023/07/15', TO_TIMESTAMP('2023-07-15 08:59:02', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-07-15 18:06:18', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, OBJECTION_REASON) 
    VALUES (SEQ_ATTENDANCE_NO.NEXTVAL, 1, 1, '2023/07/16', TO_TIMESTAMP('2023-07-16 08:53:03', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-07-16 18:02:34', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, OBJECTION_REASON) 
...
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, PLUS_WORK_TIME, OBJECTION_REASON) 
    VALUES (SEQ_ATTENDANCE_NO.NEXTVAL, 1, 1, '2023/07/18', TO_TIMESTAMP('2023-07-18 08:57:46', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-07-18 18:01:34', 'YYYY-MM-DD HH24:MI:SS'), INTERVAL '3' HOUR, null);
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, PLUS_WORK_TIME, OBJECTION_REASON) 
    VALUES (SEQ_ATTENDANCE_NO.NEXTVAL, 3, 6, '2023/07/18', TO_TIMESTAMP('2023-07-18 08:57:46', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-07-18 18:01:34', 'YYYY-MM-DD HH24:MI:SS'), INTERVAL '1' HOUR, '지하철 시위로 대중교통이 지연되었어요.');
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, OBJECTION_REASON) 
