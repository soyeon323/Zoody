...
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, PLUS_WORK_TIME, OBJECTION_REASON) 
    VALUES (SEQ_ATTENDANCE_NO.NEXTVAL, 1, 1, '2023/07/11', TO_TIMESTAMP('2023-07-11 08:57:03', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-07-11 18:01:34', 'YYYY-MM-DD HH24:MI:SS'), INTERVAL '3' HOUR, null);
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, PLUS_WORK_TIME, OBJECTION_REASON) 
...
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, PLUS_WORK_TIME, OBJECTION_REASON) 
    VALUES (SEQ_ATTENDANCE_NO.NEXTVAL, 1, 1, '2023/07/18', TO_TIMESTAMP('2023-07-18 08:57:46', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-07-18 18:01:34', 'YYYY-MM-DD HH24:MI:SS'), INTERVAL '1' HOUR, null);
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, PLUS_WORK_TIME, OBJECTION_REASON) 
    VALUES (SEQ_ATTENDANCE_NO.NEXTVAL, 3, 6, '2023/07/18', TO_TIMESTAMP('2023-07-18 08:57:46', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-07-18 18:01:34', 'YYYY-MM-DD HH24:MI:SS'), INTERVAL '0 1:15:30' DAY TO SECOND, '지하철 시위로 대중교통이 지연되었어요.');
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, OBJECTION_REASON) 
