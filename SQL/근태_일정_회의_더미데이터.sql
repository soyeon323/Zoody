...
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, PLUS_WORK_TIME, OBJECTION_REASON) 
    VALUES (SEQ_ATTENDANCE_NO.NEXTVAL, 3, 6, '2023/08/10', TO_TIMESTAMP('2023-08-10 08:57:46', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2023-08-10 18:01:34', 'YYYY-MM-DD HH24:MI:SS'), INTERVAL '0 3:35:30' DAY TO SECOND, '지하철 시위로 대중교통이 지연되었어요.');
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, OBJECTION_REASON) 
    VALUES (SEQ_ATTENDANCE_NO.NEXTVAL, 1, 3, '2023/08/11', NULL, NULL,NULL);
INSERT INTO ATTENDANCE(NO, USER_NO, CURRENT_NO, ENROLLDATE, CHECK_IN_TIME, CHECK_OUT_TIME, OBJECTION_REASON) 
