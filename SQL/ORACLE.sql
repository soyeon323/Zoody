...
DROP SEQUENCE SEQ_WORK_CHECKLIST_NO;
...
DROP SEQUENCE SEQ_EXTRA_WORK_NO;
...
DROP SEQUENCE SEQ_APP_FOR_EXTRA_WORK_NO;
...
CREATE SEQUENCE SEQ_WORK_CHECKLIST_NO;
...
CREATE SEQUENCE SEQ_EXTRA_WORK_NO;
...
CREATE SEQUENCE SEQ_APP_FOR_EXTRA_WORK_NO;
...
CREATE TABLE "SUGGESTION" (
	...
	"BOARD_LIMIT"	NUMBER	DEFAULT 2	NULL
);
...
CREATE TABLE "CALENDAR" (
    ...
    "ALL_DAY"   NUMBER DEFAULT 0    NOT NULL
);
...
CREATE TABLE "ATTENDANCE" (
	...
	"PLUS_WORK_TIME"	INTERVAL DAY TO SECOND	DEFAULT INTERVAL '0' HOUR	NULL,
...
-- EXTRA_WORK
DROP TABLE "EXTRA_WORK" CASCADE CONSTRAINTS;
CREATE TABLE "EXTRA_WORK" (
	...
	"APPROVAL_STATUS"	NUMBER	DEFAULT 0	NOT NULL,
...
CREATE TABLE "MAIL_CC" (
    ...
    "BOOKMARK_CHECK" CHAR(1) DEFAULT 'X',
    "READ_CHECK" CHAR(1) DEFAULT 'X',
    "DUMP_CHECK" CHAR(1) DEFAULT 'X'
);
...
CREATE TABLE "MAILBOX" (
	"NO"	NUMBER		NOT NULL,
	"USER_NO"	NUMBER		NOT NULL,
	"NAME"	VARCHAR2(100)	DEFAULT '??Æ?´?'	NOT NULL
);
...
CREATE TABLE "TODO_LIST" (
	"NO"	NUMBER		NOT NULL,
	"PROJECT_TODO_NO"	NUMBER		NOT NULL,
	"CONTENT"	VARCHAR2(1000)		NOT NULL
);
...
--  ANIMAL_WORK 
DROP TABLE "ANIMAL_WORK" CASCADE CONSTRAINTS;
CREATE TABLE "ANIMAL_WORK" (
	"NO"	NUMBER		NOT NULL,
    "USER_NO" NUMBER NOT NULL,
	"NAME"	VARCHAR2(100)		NOT NULL,
	"DATE"	TIMESTAMP	DEFAULT SYSDATE  NULL,
	"STATUS"	CHAR(1)	DEFAULT 'X'	NOT NULL
);
...
CREATE TABLE "CHATTING_MESSAGE" (
	...
	"PROJECT_NO"	NUMBER		NOT NULL,
	"CONTENT"	VARCHAR2(1000)		NOT NULL,
	"SEND_TIME"	VARCHAR2(10)	DEFAULT SYSDATE	NOT NULL
);
...
--
---- PK 
--ALTER TABLE "EXTRA_WORK" ADD CONSTRAINT "PK_EXTRA_WORK" PRIMARY KEY (
--	"NO"
--);
